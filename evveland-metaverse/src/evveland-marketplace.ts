...
export function handleApproval(event: Approval): void {
  ...
  //
  // - contract.balanceOf(...)
  // - contract.checkTokenURIExists(...)
  // - contract.getAllListedMarketItems(...)
  // - contract.getApproved(...)
  // - contract.getListedItemsCount(...)
  // - contract.getListingPrice(...)
  // - contract.getMarketItem(...)
  // - contract.getTokenOfOwnerByIndex(...)
  // - contract.getUserOwnedNfts(...)
...
export function handleMarketItemPurchased(event: MarketItemPurchased): void {}
